 ...
 *
 */
function br_bp_enqueue_scripts() {

	// Register and enqueue default styles.
	wp_register_style( 'br_bp_styles', get_template_directory_uri() . '/style.min.css', array(), false, 'all' );
	wp_enqueue_style( 'br_bp_styles' );

	// Register and enqueue vendor scripts.
	wp_register_script( 'br_bp_vendor_scripts', get_template_directory_uri() . '/assets/js/vendor.min.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'br_bp_vendor_scripts' );
	...
	if (
		...
		wp_register_script( 'br_bp_google_maps_scripts', "https://maps.googleapis.com/maps/api/js?key=$google_maps_api_key", array( 'jquery' ), false, true );
		wp_enqueue_script( 'br_bp_google_maps_scripts' );
	}
...
add_action( 'wp_enqueue_scripts', 'br_bp_enqueue_scripts' );
 ...
 *
 */
function br_bp_enqueue_admin_scripts() {

	// Enqueue admin scripts.
	wp_register_script( 'br_bp_admin_scripts', get_template_directory_uri() . '/assets/js/admin.min.js', array(), false, true );
	wp_enqueue_script( 'br_bp_admin_scripts' );
}
add_action( 'admin_enqueue_scripts', 'br_bp_enqueue_admin_scripts' );
